...
// 1. CONSTANTS
export const LOG_PREFIX = `[NemoPromptTools]`;
export const NEMO_EXTENSION_NAME = "NemoPromptTools";
...
// 2. PATH HELPERS
/**
 * Get the full path to a file within the NemoPromptTools extension directory.
 * Use this instead of hardcoding 'scripts/extensions/third-party/NemoPromptTools/...' everywhere.
